...
const citys = ['Анапа', 'Брянск', 'Владимир', 'Волгоград', 'Воронеж', 'Геленджик', 'Дзержинск', 'Ейск', 'Екатеринбург', 'Елабуга', 'Иркутск', 'Калининград', 'Каменск-Уральский', 'Краснодар', 'Кстово', 'Курган', 'Курск', 'Москва', 'Нижнекамск', 'Нижний Новгород', 'Октябрьский', 'Омск', 'Оренбург', 'Орск', 'Пенза', 'Пермь', 'Петрозаводск', 'Пятигорск', 'Самара', 'Санкт-Петербург', 'Саратов', 'Севастополь', 'Сочи', 'Таганрог', 'Тула', 'Тюмень', 'Челябинск', 'Шахты', 'Якутск', 'Ярославль']
