...
function re(i, e) {
    ...
    Object.keys(e).forEach(t => {
        typeof i[t] > "u" ? i[t] = e[t] : oe(e[t]) && oe(i[t]) && Object.keys(e[t]).length > 0 && re(i[t], e[t])
    }
    )
}
const me = {
    ...
    for (let t = 1; t < arguments.length; t += 1) {
        ...
        if (s != null && !Le(s)) {
            ...
            for (let r = 0, o = n.length; r < o; r += 1) {
                ...
                a !== void 0 && a.enumerable && (H(i[l]) && H(s[l]) ? s[l].__swiper__ ? i[l] = s[l] : G(i[l], s[l]) : !H(i[l]) && H(s[l]) ? (i[l] = {},
...
function he(i) {
    ...
    const f = t > r ? "next" : "prev"
      , u = (h, m) => f === "next" && h >= m || f === "prev" && h <= m
      , p = () => {
        l = new Date().getTime(),
        o === null && (o = l);
...
function B(i, e) {
    e === void 0 && (e = "");
    const t = [...i.children];
    return i instanceof HTMLSlotElement && t.push(...i.assignedElements()),
...
function ke(i) {
    ...
    return !u && w && t.touch && T.indexOf(`${l}x${a}`) >= 0 && (u = r.match(/(Version)\/([\d.]+)/),
    u || (u = [0, 1, "13_0_0"]),
    w = !1),
    f && !m && (o.os = "android",
    o.android = !0),
        ...
        !e || e.destroyed || !e.initialized || (r = new ResizeObserver(p => {
            o = n.requestAnimationFrame( () => {
                ...
                let w = h
                  , T = m;
                p.forEach(C => {
                    let {contentBoxSize: y, contentRect: d, target: c} = C;
                    c && c !== e.el || (w = d ? d.width : (y[0] || y).inlineSize,
                    T = d ? d.height : (y[0] || y).blockSize)
                }
                ),
                (w !== h || T !== m) && l()
            }
...
function He() {
    ...
    const t = i.params
      ...
      , u = B(n, `.${i.params.slideClass}, swiper-slide`)
    ...
    typeof C == "function" && (C = t.slidesOffsetAfter.call(i));
    ...
    t.centeredSlides && t.cssMode && (N(s, "--swiper-centered-offset-before", ""),
    ...
    for (let S = 0; S < p; S += 1) {
        ...
        let x;
        if (u[S] && (x = u[S]),
        A && i.grid.updateSlide(S, x, u),
        !(u[S] && $(x, "display") === "none")) {
            if (t.slidesPerView === "auto") {
                z && (u[S].style[i.getDirectionLabel("width")] = "");
                ...
                t.roundLengths)
                    L = i.isHorizontal() ? ie(x, "width") : ie(x, "height");
                else {
                    const I = e(M, "width")
                      , O = e(M, "padding-left")
                      , ye = e(M, "padding-right")
                      , ne = e(M, "margin-left")
                      , ae = e(M, "margin-right")
                      , le = M.getPropertyValue("box-sizing");
                    if (le && le === "border-box")
                        L = I + ne + ae;
                    else {
                        const {clientWidth: be, offsetWidth: xe} = x;
                        L = I + O + ye + ne + ae + (xe - be)
                    }
                }
                ...
                L = (r - (t.slidesPerView - 1) * c) / t.slidesPerView,
                t.roundLengths && (L = Math.floor(L)),
                u[S] && (u[S].style[i.getDirectionLabel("width")] = `${L}px`);
            u[S] && (u[S].swiperSlideSize = L),
            w.push(L),
            t.centeredSlides ? (g = g + L / 2 + v / 2 + c,
            v === 0 && S !== 0 && (g = g - r / 2 - c),
            S === 0 && (g = g - r / 2 - c),
            ...
            (E - Math.min(i.params.slidesPerGroupSkip, E)) % i.params.slidesPerGroup === 0 && h.push(g),
            m.push(g),
            g = g + L + c),
            i.virtualSize += L + c,
            v = L,
    ...
    if (i.virtualSize = Math.max(i.virtualSize, r) + C,
    ...
    A && i.grid.updateWrapperSize(L, h),
    !t.centeredSlides) {
        const S = [];
        for (let x = 0; x < h.length; x += 1) {
            let M = h[x];
            t.roundLengths && (M = Math.floor(M)),
            h[x] <= i.virtualSize - r && S.push(M)
        }
        h = S,
    ...
    c !== 0) {
        ...
        u.filter( (x, M) => !t.cssMode || t.loop ? !0 : M !== u.length - 1).forEach(x => {
            x.style[S] = `${c}px`
        }
        )
    }
    ...
    t.centeredSlides && t.cssMode && !t.centeredSlidesBounds) {
        N(s, "--swiper-centered-offset-before", `${-h[0]}px`),
        N(s, "--swiper-centered-offset-after", `${i.size / 2 - w[w.length - 1] / 2}px`);
        const S = -i.snapGrid[0]
          , x = -i.slidesGrid[0];
        i.snapGrid = i.snapGrid.map(M => M + S),
        i.slidesGrid = i.slidesGrid.map(M => M + x)
    }
    if (p !== f && i.emit("slidesLengthChange"),
    h.length !== y && (i.params.watchOverflow && i.checkOverflow(),
...
function We(i) {
    ...
    for (let a = 0; a < s.length; a += 1) {
        ...
        const p = (o + (t.centeredSlides ? e.minTranslate() : 0) - u) / (f.swiperSlideSize + l)
          , h = (o - r[0] + (t.centeredSlides ? e.minTranslate() : 0) - u) / (f.swiperSlideSize + l)
          , m = -(o - u)
          , w = m + e.slidesSizesGrid[a]
          , T = m >= 0 && m <= e.size - e.slidesSizesGrid[a]
          , C = m >= 0 && m < e.size - 1 || w > 1 && w <= e.size || m <= 0 && w >= e.size;
        C && (e.visibleSlides.push(f),
        e.visibleSlidesIndexes.push(a)),
        de(f, C, t.slideVisibleClass),
        de(f, T, t.slideFullyVisibleClass),
        f.progress = n ? -p : p,
        f.originalProgress = n ? -h : h
    }
}
function je(i) {
    const e = this;
...
function qe() {
    const i = this
      ...
      , l = p => B(s, `.${t.slideClass}${p}, swiper-slide${p}`)[0];
    let a, f, u;
    if (r)
        if (t.loop) {
        ...
        f = e.filter(p => p.column === n - 1)[0]) : a = e[n];
    a && (o || (u = Oe(a, `.${t.slideClass}, swiper-slide`)[0],
    t.loop && !u && (u = e[0]),
    f = Ae(a, `.${t.slideClass}, swiper-slide`)[0],
    t.loop && !f === 0 && (f = e[e.length - 1]))),
    e.forEach(p => {
        J(p, p === a, t.slideActiveClass),
        J(p, p === u, t.slideNextClass),
        J(p, p === f, t.slidePrevClass)
    }
    ),
    i.emitSlidesClasses()
}
...
function Xe(i) {
    ...
    const u = m => {
        ...
        return w < 0 && (w = e.virtual.slides.length + w),
        w >= e.virtual.slides.length && (w -= e.virtual.slides.length),
        w
    }
    ;
    if (typeof a > "u" && (a = Ye(e)),
    s.indexOf(t) >= 0)
        f = s.indexOf(t);
    else {
        const m = Math.min(n.slidesPerGroupSkip, a);
        f = m + Math.floor((a - m) / n.slidesPerGroup)
    }
...
function Qe(i, e) {
    ...
    r.style.transform = `translate3d(${l}px, ${a}px, ${f}px)`);
    let u;
...
function lt(i, e, t, s, n) {
    ...
    let o = i;
    o < 0 && (o = 0);
    const {params: l, snapGrid: a, slidesGrid: f, previousIndex: u, activeIndex: p, rtlTranslate: h, wrapperEl: m, enabled: w} = r;
    if (!w && !s && !n || r.destroyed || r.animating && l.preventInteractionOnTransition)
        return !1;
    typeof e > "u" && (e = r.params.speed);
    const T = Math.min(r.params.slidesPerGroupSkip, o);
    let C = T + Math.floor((o - T) / r.params.slidesPerGroup);
    C >= a.length && (C = a.length - 1);
    const y = -a[C];
    if (l.normalizeSlideIndex)
        for (let v = 0; v < f.length; v += 1) {
            const E = -Math.floor(y * 100)
              , A = Math.floor(f[v] * 100)
              , L = Math.floor(f[v + 1] * 100);
            typeof f[v + 1] < "u" ? E >= A && E < L - (L - A) / 2 ? o = v : E >= A && E < L && (o = v + 1) : E >= A && (o = v)
        }
    if (r.initialized && o !== p && (!r.allowSlideNext && (h ? y > r.translate && y > r.minTranslate() : y < r.translate && y < r.minTranslate()) || !r.allowSlidePrev && y > r.translate && y > r.maxTranslate() && (p || 0) !== o))
        return !1;
    ...
    if (!(c && n) && (h && -y === r.translate || !h && y === r.translate))
    ...
    if (n.params.loop)
        if (n.virtual && n.params.virtual.enabled)
            ...
            const a = r ? Math.ceil(n.slides.length / n.params.grid.rows) : n.slides.length
              , {centeredSlides: f} = n.params;
            let u = n.params.slidesPerView;
            u === "auto" ? u = n.slidesPerViewDynamic() : (u = Math.ceil(parseFloat(n.params.slidesPerView, 10)),
            f && u % 2 === 0 && (u = u + 1));
            let p = a - l < u;
            if (f && (p = p || l < Math.ceil(u / 2)),
            s && f && n.params.slidesPerView !== "auto" && !r && (p = !1),
            p) {
                const h = f ? l < n.activeIndex ? "prev" : "next" : l - n.activeIndex - 1 < n.params.slidesPerView ? "next" : "prev";
                n.loopFix({
                    direction: h,
                    slideTo: !0,
...
function ct(i, e, t) {
    e === void 0 && (e = !0);
    const s = this
      , {params: n, snapGrid: r, slidesGrid: o, rtlTranslate: l, enabled: a, animating: f} = s;
    if (!a || s.destroyed)
        return s;
    typeof i > "u" && (i = s.params.speed);
    const u = s.virtual && n.virtual.enabled;
    if (n.loop) {
        if (f && !u && n.loopPreventsSliding)
            return !1;
        s.loopFix({
            direction: "prev"
        }),
    ...
    const m = h(p)
      , w = r.map(y => h(y));
    let T = r[w.indexOf(m) - 1];
    if (typeof T > "u" && n.cssMode) {
        let y;
        r.forEach( (d, c) => {
            m >= d && (y = c)
        }
        ),
        typeof y < "u" && (T = r[y > 0 ? y - 1 : y])
    }
    let C = 0;
    if (typeof T < "u" && (C = o.indexOf(T),
    C < 0 && (C = s.activeIndex - 1),
    n.slidesPerView === "auto" && n.slidesPerGroup === 1 && n.slidesPerGroupAuto && (C = C - s.slidesPerViewDynamic("previous", !0) + 1,
    C = Math.max(C, 0))),
...
function ut(i, e, t, s) {
    ...
    if (a >= n.snapGrid[l]) {
        const f = n.snapGrid[l]
          , u = n.snapGrid[l + 1];
        a - f > (u - f) * s && (r += n.params.slidesPerGroup)
    } else {
        const f = n.snapGrid[l - 1]
          , u = n.snapGrid[l];
        a - f <= (u - f) * s && (r -= n.params.slidesPerGroup)
    }
...
function pt() {
    ...
    if (e.loop) {
        ...
        n = i.getSlideIndex(B(t, `${o}[data-swiper-slide-index="${r}"]`)[0]),
        te( () => {
            i.slideTo(n)
        }
...
function ht(i) {
    ...
    if (!t.loop || e.virtual && e.params.virtual.enabled)
        return;
    const n = () => {
        B(s, `.${t.slideClass}, swiper-slide`).forEach( (p, h) => {
...
function gt(i) {
    ...
    const {slides: f, allowSlidePrev: u, allowSlideNext: p, slidesEl: h, params: m} = a
      , {centeredSlides: w} = m;
    ...
    let T = m.slidesPerView;
    T === "auto" ? T = a.slidesPerViewDynamic() : (T = Math.ceil(parseFloat(m.slidesPerView, 10)),
    w && T % 2 === 0 && (T = T + 1));
    const C = m.slidesPerGroupAuto ? T : m.slidesPerGroup;
    let y = C;
    y % C !== 0 && (y += C - y % C),
    y += m.loopAdditionalSlides,
    a.loopedSlides = y;
    const d = a.grid && m.grid && m.grid.rows > 1;
    f.length < T + y ? j("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : d && m.grid.fill === "row" && j("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
    const c = []
      , g = [];
    let v = a.activeIndex;
    typeof r > "u" ? r = a.getSlideIndex(f.filter(b => b.classList.contains(m.slideActiveClass))[0]) : v = r;
    const E = s === "next" || !s
      , A = s === "prev" || !s;
    let L = 0
      , z = 0;
    const S = d ? Math.ceil(f.length / m.grid.rows) : f.length
      , M = (d ? f[r].column : r) + (w && typeof n > "u" ? -T / 2 + .5 : 0);
    if (M < y) {
        L = Math.max(y - M, C);
        for (let b = 0; b < y - M; b += 1) {
            const P = b - Math.floor(b / S) * S;
            if (d) {
                const I = S - P - 1;
                for (let O = f.length - 1; O >= 0; O -= 1)
                    f[O].column === I && c.push(O)
            } else
                c.push(S - P - 1)
        }
    } else if (M + T > S - y) {
        z = Math.max(M - (S - y * 2), C);
        for (let b = 0; b < z; b += 1) {
            const P = b - Math.floor(b / S) * S;
            d ? f.forEach( (I, O) => {
                I.column === P && g.push(O)
    ...
    A && c.forEach(b => {
        f[b].swiperLoopMoveDOM = !0,
        h.prepend(f[b]),
        f[b].swiperLoopMoveDOM = !1
    }
    ),
    E && g.forEach(b => {
        f[b].swiperLoopMoveDOM = !0,
    ...
    a.recalcSlides(),
    m.slidesPerView === "auto" ? a.updateSlides() : d && (c.length > 0 && A || g.length > 0 && E) && a.slides.forEach( (b, P) => {
    ...
    t) {
        if (c.length > 0 && A) {
            if (typeof e > "u") {
                const b = a.slidesGrid[v]
                  , I = a.slidesGrid[v + L] - b;
                l ? a.setTranslate(a.translate - I) : (a.slideTo(v + Math.ceil(L), 0, !1, !0),
            ...
            if (typeof e > "u") {
                const b = a.slidesGrid[v]
                  , I = a.slidesGrid[v - z] - b;
                l ? a.setTranslate(a.translate - I) : (a.slideTo(v - z, 0, !1, !0),
                n && (a.touchEventsData.startTranslate = a.touchEventsData.startTranslate - I,
                a.touchEventsData.currentTranslate = a.touchEventsData.currentTranslate - I))
            } else {
                const b = d ? g.length / m.grid.rows : g.length;
                a.slideTo(a.activeIndex - b, 0, !1, !0)
            }
    }
...
function xt(i) {
    ...
    let a = s.target;
    if (r.touchEventsTarget === "wrapper" && !ze(a, e.wrapperEl) || "which"in s && s.which === 3 || "button"in s && s.button > 0 || n.isTouched && n.isMoved)
        return;
    ...
    if (r.noSwiping && (h ? bt(p, a) : a.closest(p))) {
        e.allowClick = !0;
        return
    }
    ...
    const C = T && e.allowTouchMove && r.touchStartPreventDefault;
    (r.touchStartForcePreventDefault || C) && !a.isContentEditable && s.preventDefault(),
...
function Et(i) {
    ...
    let f;
    if (a.type === "touchmove") {
        if (f = [...a.changedTouches].filter(E => E.identifier === s.touchId)[0],
    ...
    if (typeof s.isScrolling > "u") {
        let E;
        t.isHorizontal() && r.currentY === r.startY || t.isVertical() && r.currentX === r.startX ? s.isScrolling = !1 : h * h + m * m >= 25 && (E = Math.atan2(Math.abs(m), Math.abs(h)) * 180 / Math.PI,
    ...
    let c;
    if (new Date().getTime(),
    s.isMoved && s.allowThresholdMove && C !== t.touchesDirection && y && d && Math.abs(w) >= 1) {
        Object.assign(r, {
            startX: u,
            startY: p,
            currentX: u,
    ...
    w > 0 ? (y && d && !c && s.allowThresholdMove && s.currentTranslate > (n.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] - (n.slidesPerView !== "auto" && t.slides.length - n.slidesPerView >= 2 ? t.slidesSizesGrid[t.activeIndex + 1] + t.params.spaceBetween : 0) - t.params.spaceBetween : t.minTranslate()) && t.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    s.currentTranslate > t.minTranslate() && (g = !1,
    n.resistance && (s.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + s.startTranslate + w) ** v))) : w < 0 && (y && d && !c && s.allowThresholdMove && s.currentTranslate < (n.centeredSlides ? t.maxTranslate() + t.slidesSizesGrid[t.slidesSizesGrid.length - 1] + t.params.spaceBetween + (n.slidesPerView !== "auto" && t.slides.length - n.slidesPerView >= 2 ? t.slidesSizesGrid[t.slidesSizesGrid.length - 1] + t.params.spaceBetween : 0) : t.maxTranslate()) && t.loopFix({
        direction: "next",
        setTranslate: !0,
    ...
    n.resistance && (s.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - s.startTranslate - w) ** v))),
...
function Ct(i) {
    ...
    t.pointerId = null,
    t.touchId = null;
    const {params: o, touches: l, rtlTranslate: a, slidesGrid: f, enabled: u} = e;
    ...
    const w = m >= -e.maxTranslate() && !e.params.loop;
    let T = 0
      , C = e.slidesSizesGrid[0];
    for (let v = 0; v < f.length; v += v < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup) {
        const E = v < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
        typeof f[v + E] < "u" ? (w || m >= f[v] && m < f[v + E]) && (T = v,
        C = f[v + E] - f[v]) : (w || m >= f[v]) && (T = v,
        C = f[f.length - 1] - f[f.length - 2])
    }
    let y = null
      , d = null;
    o.rewind && (e.isBeginning ? d = o.virtual && o.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1 : e.isEnd && (y = 0));
    const c = (m - f[T]) / C
      , g = T < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
    if (h > o.longSwipesMs) {
        if (!o.longSwipes) {
            e.slideTo(e.activeIndex);
            return
        }
        e.swipeDirection === "next" && (c >= o.longSwipesRatio ? e.slideTo(o.rewind && e.isEnd ? y : T + g) : e.slideTo(T)),
        e.swipeDirection === "prev" && (c > 1 - o.longSwipesRatio ? e.slideTo(T + g) : d !== null && c < 0 && Math.abs(c) > o.longSwipesRatio ? e.slideTo(d) : e.slideTo(T))
    } else {
        if (!o.shortSwipes) {
            e.slideTo(e.activeIndex);
            return
        }
        e.navigation && (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl) ? s.target === e.navigation.nextEl ? e.slideTo(T + g) : e.slideTo(T) : (e.swipeDirection === "next" && e.slideTo(y !== null ? y : T + g),
        e.swipeDirection === "prev" && e.slideTo(d !== null ? d : T))
    }
}
function fe() {
    const i = this
...
const Te = (i, e) => {
    ...
    s.updateOnWindowResize ? i[f](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", fe, !0) : i[f]("observerUpdate", fe, !0),
    n[a]("load", i.onLoad, {
        capture: !0
    }))
}
...
function zt() {
    const i = this
      , {params: e} = i;
    i.onTouchStart = xt.bind(i),
    i.onTouchMove = Et.bind(i),
    i.onTouchEnd = Ct.bind(i),
    i.onDocumentTouchStart = Lt.bind(i),
    e.cssMode && (i.onScroll = Pt.bind(i)),
    i.onClick = Mt.bind(i),
    i.onLoad = It.bind(i),
    Te(i, "on")
}
...
function Gt() {
    ...
    const a = (o in r ? r[o] : void 0) || i.originalParams
      ...
      , h = a.grabCursor
      , m = s.enabled;
    f && !u ? (n.classList.remove(`${s.containerModifierClass}grid`, `${s.containerModifierClass}grid-column`),
    i.emitContainerClasses()) : !f && u && (n.classList.add(`${s.containerModifierClass}grid`),
    (a.grid.fill && a.grid.fill === "column" || !a.grid.fill && s.grid.fill === "column") && n.classList.add(`${s.containerModifierClass}grid-column`),
    i.emitContainerClasses()),
    p && !h ? i.unsetGrabCursor() : !p && h && i.setGrabCursor(),
    ...
    const w = a.direction && a.direction !== s.direction
      , T = s.loop && (a.slidesPerView !== s.slidesPerView || w)
      , C = s.loop;
    w && t && i.changeDirection(),
    G(i.params, a);
    ...
    t && (T ? (i.loopDestroy(),
    i.loopCreate(e),
    i.updateSlides()) : !C && d ? (i.loopCreate(e),
    i.updateSlides()) : C && !d && i.loopDestroy()),
    i.emit("breakpoint", a)
}
function kt(i, e, t) {
    ...
    for (let l = 0; l < o.length; l += 1) {
        ...
        e === "window" ? n.matchMedia(`(min-width: ${f}px)`).matches && (s = a) : f <= t.clientWidth && (s = a)
    }
    return s || "max"
}
var Dt = {
...
class D {
    ...
    getSlideIndex(e) {
        const {slidesEl: t, params: s} = this
          , n = B(t, `.${s.slideClass}, swiper-slide`)
          , r = Y(n[0]);
        return Y(e) - r
    }
    ...
    recalcSlides() {
        ...
        e.slides = B(t, `.${s.slideClass}, swiper-slide`)
    }
    enable() {
        const e = this;
    ...
    slidesPerViewDynamic(e, t) {
        ...
        t === void 0 && (t = !1);
        const s = this
          , {params: n, slides: r, slidesGrid: o, slidesSizesGrid: l, size: a, activeIndex: f} = s;
        let u = 1;
        if (typeof n.slidesPerView == "number")
            return n.slidesPerView;
        if (n.centeredSlides) {
            let p = r[f] ? Math.ceil(r[f].swiperSlideSize) : 0, h;
            for (let m = f + 1; m < r.length; m += 1)
                r[m] && !h && (p += Math.ceil(r[m].swiperSlideSize),
                u += 1,
                p > a && (h = !0));
    ...
    mount(e) {
        ...
        let o = s && s.shadowRoot && s.shadowRoot.querySelector ? s.shadowRoot.querySelector(n()) : B(s, n())[0];
        return !o && t.params.createElements && (o = q("div", t.params.wrapperClass),
        s.append(o),
        B(s, `.${t.params.slideClass}`).forEach(l => {
            o.append(l)
        }
        )),
        Object.assign(t, {
    ...
    static use(e) {
        return Array.isArray(e) ? (e.forEach(t => D.installModule(t)),
        D) : (D.installModule(e),
        D)
    }
}
...
function qt(i) {
    ...
    function f(d, c) {
        ...
        d && (d.classList.add(`${g}-${c}`),
        d = d[`${c === "prev" ? "previous" : "next"}ElementSibling`],
        d && d.classList.add(`${g}-${c}-${c}`)))
    }
    function u(d, c, g) {
        if (d = d % g,
        c = c % g,
    ...
    function p(d) {
        ...
        if (e.params.loop) {
            if (e.realIndex === g)
                return;
            const v = u(e.realIndex, g, e.slides.length);
            v === "next" ? e.slideNext() : v === "previous" ? e.slidePrev() : e.slideToLoop(g)
        } else
            e.slideTo(g)
    }
    function h() {
        ...
        const A = e.virtual && e.params.virtual.enabled ? e.virtual.slides.length : e.slides.length
          , L = e.params.loop ? Math.ceil(A / e.params.slidesPerGroup) : e.snapGrid.length;
        ...
        E = e.previousSnapIndex) : (E = e.previousIndex || 0,
        v = e.activeIndex || 0),
        c.type === "bullets" && e.pagination.bullets && e.pagination.bullets.length > 0) {
            const z = e.pagination.bullets;
            let S, x, M;
            if (c.dynamicBullets && (o = ie(z[0], e.isHorizontal() ? "width" : "height"),
            g.forEach(b => {
                b.style[e.isHorizontal() ? "width" : "height"] = `${o * (c.dynamicMainBullets + 4)}px`
            }
            ),
            c.dynamicMainBullets > 1 && E !== void 0 && (l += v - (E || 0),
            l > c.dynamicMainBullets - 1 ? l = c.dynamicMainBullets - 1 : l < 0 && (l = 0)),
            S = Math.max(v - l, 0),
            x = S + (Math.min(z.length, c.dynamicMainBullets) - 1),
            M = (x + S) / 2),
            z.forEach(b => {
                const P = [...["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(I => `${c.bulletActiveClass}${I}`)].map(I => typeof I == "string" && I.includes(" ") ? I.split(" ") : I).flat();
            ...
            g.length > 1)
                z.forEach(b => {
                    const P = Y(b);
                    P === v ? b.classList.add(...c.bulletActiveClass.split(" ")) : e.isElement && b.setAttribute("part", "bullet"),
                    c.dynamicBullets && (P >= S && P <= x && b.classList.add(...`${c.bulletActiveClass}-main`.split(" ")),
                    P === S && f(b, "prev"),
                    P === x && f(b, "next"))
                }
                );
                ...
                e.isElement && z.forEach( (P, I) => {
                    P.setAttribute("part", I === v ? "bullet-active" : "bullet")
                }
                ),
                c.dynamicBullets) {
                    const P = z[S]
                      , I = z[x];
                    for (let O = S; O <= x; O += 1)
                        z[O] && z[O].classList.add(...`${c.bulletActiveClass}-main`.split(" "));
                    f(P, "prev"),
                    f(I, "next")
                }
            }
            if (c.dynamicBullets) {
                const b = Math.min(z.length, c.dynamicMainBullets + 4)
                  , P = (o * b - o) / 2 - M * o
                  , I = d ? "right" : "left";
                z.forEach(O => {
        ...
        g.forEach( (z, S) => {
            if (c.type === "fraction" && (z.querySelectorAll(_(c.currentClass)).forEach(x => {
                x.textContent = c.formatFractionCurrent(v + 1)
            }
            ),
            z.querySelectorAll(_(c.totalClass)).forEach(x => {
                x.textContent = c.formatFractionTotal(L)
            }
            )),
            c.type === "progressbar") {
                let x;
                c.progressbarOpposite ? x = e.isHorizontal() ? "vertical" : "horizontal" : x = e.isHorizontal() ? "horizontal" : "vertical";
                const M = (v + 1) / L;
                let b = 1
                  , P = 1;
                x === "horizontal" ? b = M : P = M,
                z.querySelectorAll(_(c.progressbarFillClass)).forEach(I => {
                    I.style.transform = `translate3d(0,0,0) scaleX(${b}) scaleY(${P})`,
                    I.style.transitionDuration = `${e.params.speed}ms`
                }
                )
            }
            c.type === "custom" && c.renderCustom ? (z.innerHTML = c.renderCustom(e, v + 1, L),
            S === 0 && n("paginationRender", z)) : (S === 0 && n("paginationRender", z),
            n("paginationUpdate", z)),
            e.params.watchOverflow && e.enabled && z.classList[e.isLocked ? "add" : "remove"](c.lockClass)
        }
        )
    }
    function m() {
        ...
        if (d.type === "bullets") {
            ...
            for (let A = 0; A < E; A += 1)
                d.renderBullet ? v += d.renderBullet.call(e, A, d.bulletClass) : v += `<${d.bulletElement} ${e.isElement ? 'part="bullet"' : ""} class="${d.bulletClass}"></${d.bulletElement}>`
        }
        d.type === "fraction" && (d.renderFraction ? v = d.renderFraction.call(e, d.currentClass, d.totalClass) : v = `<span class="${d.currentClass}"></span> / <span class="${d.totalClass}"></span>`),
        d.type === "progressbar" && (d.renderProgressbar ? v = d.renderProgressbar.call(e, d.progressbarFillClass) : v = `<span class="${d.progressbarFillClass}"></span>`),
        e.pagination.bullets = [],
        g.forEach(E => {
            d.type !== "custom" && (E.innerHTML = v || ""),
            d.type === "bullets" && e.pagination.bullets.push(...E.querySelectorAll(_(d.bulletClass)))
        }
        ),
        d.type !== "custom" && n("paginationRender", g[0])
    }
    function w() {
        ...
        c.length > 1 && (c = c.filter(g => ge(g, ".swiper")[0] === e.el)[0])),
        ...
        c.forEach(g => {
            ...
            d.clickable && g.addEventListener("click", p),
    ...
    s("init", () => {
        e.params.pagination.enabled === !1 ? y() : (w(),
        m(),
        h())
    }
    ),
    ...
    s("click", (d, c) => {
        ...
        if (e.params.pagination.el && e.params.pagination.hideOnClick && v && v.length > 0 && !g.classList.contains(e.params.pagination.bulletClass)) {
            ...
            v.forEach(A => A.classList.toggle(e.params.pagination.hiddenClass))
        }
    }
    );
    const C = () => {
...
export {qt as P, D as S, Wt as a, q as c, jt as e, F as g};
