...
for (let i = 0; i < accordionInfo.length; i++) {
    const element = accordionInfo[i];
    element.addEventListener('click', function(){
		const accordionHeadContent = element.querySelector('.accordion__head-content');
        for (let i = 0; i < accordionInfo.length; i++) {
            const element = accordionInfo[i];
			const accordionHeadContent = element.querySelector('.accordion__head-content');
            element.classList.remove('accordion__info-active');
			accordionHeadContent.style.height = 0;
        };
        element.classList.add('accordion__info-active');
    accordionHeadContent.style.height = 0;
		accordionHeadContent.style.height = `${accordionHeadContent.scrollHeight}px`;
    });
};

// Ф-ция реализации слайдера
const swiperaccordion = new Swiper('#swiper-accordion', {
    // Optional parameters
    loop: true,
    slidesPerView: 1,
...
// Ф-ция изменения контента
const buttons = document.querySelectorAll('.accordion__head');
const accordionSlides = document.querySelectorAll('.accordion__slide');
const accordionContentWrapper = document.querySelector('.accordion__content-wrapper');
const accordionContentNav = document.querySelector('.accordion__content-nav');
for (let i = 0; i < buttons.length; i++) {
    const element = buttons[i];
    element.addEventListener('click', function () {
		accordionContentNav.style.cssText += '-ms-grid-row-span: 5; grid-row: span 15;';
        switch (element.dataset.btn) {
            case '1':
                accordionContentWrapper.style.height = '0px';
                accordionContentWrapper.style.marginBottom = '0px';
                for (let i = 0; i < accordionSlides.length; i++) {
                    const element = accordionSlides[i];
...
const accordionHeadLinks = document.querySelectorAll('.accordion__head-link');
const accordionHeadHs = document.querySelectorAll('.accordion__head-h')
for (let i = 0; i < accordionHeadLinks.length; i++) {
    const element = accordionHeadLinks[i];
    element.addEventListener('click', function(){
        for (let i = 0; i < accordionHeadHs.length; i++) {
            const element = accordionHeadHs[i];
            element.classList.remove('accordion__content-active');
        }
        for (let i = 0; i < accordionHeadLinks.length; i++) {
            const el = accordionHeadLinks[i];
            el.classList.remove('accordion__content-active');
        }
        element.classList.add('accordion__content-active');
        switch (element.dataset.btn) {
            case 'sub1':
                accordionContentWrapper.style.height = '0px';
                accordionContentWrapper.style.marginBottom = '0px';
                for (let i = 0; i < accordionSlides.length; i++) {
                    const element = accordionSlides[i];
                    if (element.dataset.content == 'sub1') {
                        element.style.height = `${element.scrollHeight}px`;
                    } else {
                        element.style.height = '0';
                    };
            ...
            case 'sub2':
                ...
                for (let i = 0; i < accordionSlides.length; i++) {
                    const element = accordionSlides[i];
                    if (element.dataset.content == 'sub2') {
                        element.style.height = `${element.scrollHeight}px`;
                    } else {
                        element.style.height = '0';
                    };
            ...
            case 'sub3':
                ...
                for (let i = 0; i < accordionSlides.length; i++) {
                    const element = accordionSlides[i];
                    if (element.dataset.content == 'sub3') {
                        element.style.height = `${element.scrollHeight}px`;
                    } else {
                        element.style.height = '0';
                    };
            ...
            case 'sub4':
                ...
                for (let i = 0; i < accordionSlides.length; i++) {
                    const element = accordionSlides[i];
                    if (element.dataset.content == 'sub4') {
                        element.style.height = `${element.scrollHeight}px`;
                    } else {
                        element.style.height = '0';
                    };
            ...
            case 'sub5':
                ...
                for (let i = 0; i < accordionSlides.length; i++) {
                    const element = accordionSlides[i];
                    if (element.dataset.content == 'sub5') {
                        element.style.height = `${element.scrollHeight}px`;
                    } else {
                        element.style.height = '0';
                    };
            ...
            case 'sub6':
                ...
                for (let i = 0; i < accordionSlides.length; i++) {
                    const element = accordionSlides[i];
                    if (element.dataset.content == 'sub6') {
                        element.style.height = `${element.scrollHeight}px`;
                    } else {
                        element.style.height = '0';
                    };
                ...
                case 'sub7':
                    ...
                    for (let i = 0; i < accordionSlides.length; i++) {
                        const element = accordionSlides[i];
                        if (element.dataset.content == 'sub7') {
                            element.style.height = `${element.scrollHeight}px`;
                        } else {
                            element.style.height = '0';
                        };
                ...
                case 'sub8':
                    ...
                    for (let i = 0; i < accordionSlides.length; i++) {
                        const element = accordionSlides[i];
                        if (element.dataset.content == 'sub8') {
                            element.style.height = `${element.scrollHeight}px`;
                        } else {
                            element.style.height = '0';
                        };
                    ...
                    case 'sub9':
                        ...
                        for (let i = 0; i < accordionSlides.length; i++) {
                            const element = accordionSlides[i];
                            if (element.dataset.content == 'sub9') {
                                element.style.height = `${element.scrollHeight}px`;
                            } else {
                                element.style.height = '0';
                            };
                    ...
                    case 'sub10':
                        ...
                        for (let i = 0; i < accordionSlides.length; i++) {
                            const element = accordionSlides[i];
                            if (element.dataset.content == 'sub10') {
                                element.style.height = `${element.scrollHeight}px`;
                            } else {
                                element.style.height = '0';
                            };
                    ...
                    case 'sub11':
                        ...
                        for (let i = 0; i < accordionSlides.length; i++) {
                            const element = accordionSlides[i];
                            if (element.dataset.content == 'sub11') {
                                element.style.height = `${element.scrollHeight}px`;
                            } else {
                                element.style.height = '0';
                            };
                    ...
                    case 'sub12':
                        ...
                        for (let i = 0; i < accordionSlides.length; i++) {
                            const element = accordionSlides[i];
                            if (element.dataset.content == 'sub12') {
                                element.style.height = `${element.scrollHeight}px`;
                            } else {
                                element.style.height = '0';
                            };
...
const sourceChannelLink = document.getElementById('source-channel-link')
const sourceChanne = document.getElementById('source-channel')
sourceChannelLink.addEventListener('click', function(e){
  e.preventDefault();
  for (let i = 0; i < accordionHeadHs.length; i++) {
    const element = accordionHeadHs[i];
    element.classList.remove('accordion__content-active');
  ...
  sourceChanne.classList.add('accordion__content-active');
  accordionContentWrapper.style.height = '0px';
  accordionContentWrapper.style.marginBottom = '0px';
  for (let i = 0; i < accordionSlides.length; i++) {
      const element = accordionSlides[i];
...
const filtersParameters = document.getElementById('filters-parameters')
const filtersParametersLink = document.getElementById('filters-parameters-link')
filtersParametersLink.addEventListener('click', function(e){
  e.preventDefault();
  for (let i = 0; i < accordionHeadHs.length; i++) {
    const element = accordionHeadHs[i];
    element.classList.remove('accordion__content-active');
  ...
  filtersParameters.classList.add('accordion__content-active');
  accordionContentWrapper.style.height = '0px';
  accordionContentWrapper.style.marginBottom = '0px';
  for (let i = 0; i < accordionSlides.length; i++) {
      const element = accordionSlides[i];
...
const connectConfigure = document.getElementById('connect-configure')
const connectConfigureLink = document.getElementById('connect-configure-link')
connectConfigureLink.addEventListener('click', function(e){
  e.preventDefault();
  for (let i = 0; i < accordionHeadHs.length; i++) {
    const element = accordionHeadHs[i];
    element.classList.remove('accordion__content-active');
  ...
  connectConfigure.classList.add('accordion__content-active');
  accordionContentWrapper.style.height = '0px';
  accordionContentWrapper.style.marginBottom = '0px';
  for (let i = 0; i < accordionSlides.length; i++) {
      const element = accordionSlides[i];
...
const AIGenerationLink = document.getElementById('AI-generation-link')
AIGenerationLink.addEventListener('click', function(e){
  e.preventDefault();
  for (let i = 0; i < accordionHeadHs.length; i++) {
    const element = accordionHeadHs[i];
    element.classList.remove('accordion__content-active');
  ...
  AIGeneration.classList.add('accordion__content-active');
  accordionContentWrapper.style.height = '0px';
  accordionContentWrapper.style.marginBottom = '0px';
  for (let i = 0; i < accordionSlides.length; i++) {
      const element = accordionSlides[i];
