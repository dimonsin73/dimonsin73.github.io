...
const registraciyaFormInvitation = document.querySelector('.registraciya__form-invitation')
registraciyaFormInvitation.addEventListener('submit', function(e){
    e.preventDefault()
    ...
    if (surname.value === '') {
        const label = surname.parentElement
        label.classList.add('label_error')
    }
